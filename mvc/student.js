...
function counter5 (state, arges){
    function onMouseDown(state, args) {
        ...
        else if ((state.count == 0 ) && (args.shift == true)){
    ...
    function onKeyDown(state, args) {
        if ((state.count > 0) && (args.key == "0")) {
            return {count: 0};
        }
        if ((args.key == "ArrowUp") || (args.key == "Space")){
            return {count: state.count +1}
        }
        if ((state.count > 0) && (args.key == "ArrowDown")){
            return {count: state.count - 1}
        }else
